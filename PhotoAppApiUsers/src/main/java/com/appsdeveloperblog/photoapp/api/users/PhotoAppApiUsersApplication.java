...
public class PhotoAppApiUsersApplication {
	...
	public String createProductionBean() {
		System.out.println("Production bean has been created : " + env.getProperty("myapplication.environment"));
	...
	public String createNotProductionBean() {
		System.out.println("Not-Production bean has been created : " + env.getProperty("myapplication.environment"));
	...
	public String createDevelopmentBean() {
		System.out.println("Development bean has been created : " + env.getProperty("myapplication.environment"));
