...
//	RestTemplate restTemplate;
	...
	public UserDto createUser(UserDto userDetails) {
		...
		// in order for map field values to work: UserEntity and UserDto attributes must
		// have same names
...
//		ResponseEntity<List<AlbumResponseModel>> ablumsListResponse = restTemplate.exchange(albumsUrl, HttpMethod.GET,
//				null, new ParameterizedTypeReference<List<AlbumResponseModel>>() {
//				});
//		List<AlbumResponseModel> albumsList = ablumsListResponse.getBody();
